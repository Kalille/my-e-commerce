...
<div className="card mb-3" style={{maxWidth: "540px"}}>
      <div className="row g-0">
        <div className="col-md-4">
          ...
          <br/>
         {showMe ? <Button onClick={handleShowmeClick}>add a review</Button>:<form onSubmit={handleSubmit}>
              <Textarea onChange={handleChange} placeholder="Leave a Review..." type='text-field'>
          </Textarea>
          ...
          <div className="card-body">
           ...
           <h3 style={{fontWieght: 'bold'}}> Reviews </h3>
            {merch ?  merch.product_reviews?.map((data,i)=>{
              return <ul key={i} className="list-group list-group-flush">
              <li  className="list-group-item"> {data.user}{data.review}</li>
...
//                             <img src={merch?.image_url} alt='none' className='rounded' width='160'/>
//                             <h5>{merch?.name}</h5>
//                             <div className='mt-3 info'>
//                               <span className='text1 d-block'>{merch?.description}</span>  
...
//                         <LikeButton likeCount={merch.liked_product?.length}id={merch.id}/>
//                                      {/* Drop a Like <Link className='thumbsUp'>{thumbsUpIcon}</Link> */}
...
//                                     <center>
//                                     Quantity: <input onChange={handleChange} type="number" style={{borders:"none", marginBottom: "100px"}}/>
//                                     </center>
...
//         </div>
//         <div className="product-container mb-5 mt-5">  <form onSubmit={handleSubmit}>
//             <Textarea onChange={handleChange} placeholder="Leave a Review" type='text-field'>
//              </Textarea>
//              <Button> Submit</Button>
//              <FormField>
