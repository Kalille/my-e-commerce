    ...
    fetch("/api/product_reviews", {
      ...
      if (r.ok) {
        ...
        r.json().then((data) => {
          ...
          setMerch((merch) => ({
            ...merch,
            product_reviews: [...merch.product_reviews, data],
          }));
        });

        // .then(setShowMe(true))
        // .then(navigate.push('/games')).then(alert("Review Submitted"))
      } else {
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text" style={{ color: "red" }}>
                <small className="text-muted">Price: ${merch?.price}</small>
              </p>

              {showMe ? (
                <Button onClick={handleShowmeClick}>add a review</Button>
              ) : (
